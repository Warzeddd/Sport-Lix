    ...
    <Section id="pricing">
      ...
      <div className="flex justify-center gap-4 max-lg:flex-col">
        <PricingCard
          title="Starter"
          price={0}
          description="To try our program"
          items={["Create 1 program", "Get dashboard"]}
        >
          <Link
        ...
        <PricingCard
          title="Premium"
          price={9.99}
          description="For sport that want to grow with the best experience"
          items={[
            "Create infinite program",
            "Get infinite sports monitoring",
            "Get precise stats",
            "Get a 'wall of dashboard'",
          ]}
        >
          {user ? (
